...
function homeViewCalc() {
   ...
   if (sliderWrapper) {
      ...
      function slideNext() {
         activeSlideIndex++;
         setHeight()
         sliderWrapper.style.transform = `translateX(-${activeSlideIndex * 100}%)`
      }
      function slidePrev() {
         activeSlideIndex--;
         setHeight()
...
if (document.getElementById('feedbackModalPhone')) {
   const mask = IMask(document.getElementById('feedbackModalPhone'), maskOptions);
}
if (document.getElementById('orderDesignModalPhone')) {
   const mask = IMask(document.getElementById('orderDesignModalPhone'), maskOptions);
}
if (document.getElementById('orderDesignModalMaterialsPhone')) {
   const mask = IMask(document.getElementById('orderDesignModalMaterialsPhone'), maskOptions);
}
...
if (document.getElementById('portfolioDetailPhone')) {
   const mask = IMask(document.getElementById('portfolioDetailPhone'), maskOptions);
}
...
function portfolioFilter() {
   ...
   if (sections.length) {
      if (window.innerWidth <= 768) {
         ...
         const dropdowns = document.querySelectorAll('.portfolio-filter__dropdown')
         ...
         sections.forEach((section, index) => {
            section.addEventListener("click", (e) => {
               if (e.target.closest(".portfolio-filter__subheader")) {
                  let currentDrop = section.querySelector(".portfolio-filter__dropdown")
      ...
      function renderCheckedFilters() {
         const servicesInputs = document.querySelectorAll("input[name='service']:checked")
         const priceInputs = document.querySelectorAll("input[name='price']:checked")
         const brandsInputs = document.querySelectorAll("input[name='brand']:checked")
         if (servicesInputs.length || priceInputs.length || brandsInputs.length) {
            ...
            const removeBtns = document.querySelectorAll('.portfolio-content__checked .icon')
   ...
   if (btns.length) {
      btns.forEach(btn => {
         btn.addEventListener("click", (e) => {
            ...
            let dropdown = section.querySelector(".materials-section__dropdown")
...
function materialsFilter() {
   ...
   if (filter) {
      ...
      document.querySelectorAll("input[name='price']").forEach(item =>
         item.addEventListener("change", renderCheckedFilters))
      document.querySelectorAll("input[name='country']").forEach(item =>
         item.addEventListener("change", renderCheckedFilters))
      document.querySelectorAll("input[name='params']").forEach(item =>
         item.addEventListener("change", renderCheckedFilters))
   }
   function spoilerSection() {
      const subHeaders = document.querySelectorAll('.materials-filter__subheader')
   ...
   function clearFilters() {
      const checkedColorFilters = document.querySelectorAll('input[name="color"]:checked')
      const checkedTypeFilters = document.querySelectorAll('input[name="type"]:checked')
      const checkedPriceFilters = document.querySelectorAll('input[name="price"]:checked')
      const checkedCountryFilters = document.querySelectorAll('input[name="country"]:checked')
      const checkedParamsFilters = document.querySelectorAll('input[name="params"]:checked')
   ...
   function renderCheckedFilters() {
      ...
      const checkedCountryFilters = document.querySelectorAll('input[name="country"]:checked')
      const checkedParamsFilters = document.querySelectorAll('input[name="params"]:checked')
      if (checkedTypeFilters.length || checkedPriceFilters.length || checkedCountryFilters.length || checkedParamsFilters.length || checkedColorFilters.length) {
         checked.classList.remove("hidden")
         let inner = "";
         checkedColorFilters.forEach(item => {
            inner += `
         ...
         checkedList.innerHTML = inner
         const removeBtns = document.querySelectorAll('.materials-content__checked .icon')
         removeBtns.forEach(item => {
            item.addEventListener("click", (e) => {
               let id = e.target.closest("li").getAttribute("data-delete");
               document.getElementById(id).checked = false;
